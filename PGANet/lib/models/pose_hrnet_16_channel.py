...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.convAttention1x1_stage1_1 = nn.Conv2d(16, 16, kernel_size=1, bias=False)
        self.bnAttention1x1_stage1 = nn.BatchNorm2d(16, momentum=BN_MOMENTUM)
        self.convAttention1x1_stage1_2 = nn.Conv2d(16, 16, kernel_size=1, bias=False)

        self.convAttention1x1_stage2_1 = nn.Conv2d(16, 16, kernel_size=1, bias=False)
        self.bnAttention1x1_stage2 = nn.BatchNorm2d(16, momentum=BN_MOMENTUM)
        self.convAttention1x1_stage2_2 = nn.Conv2d(16, 16, kernel_size=1, bias=False)

        self.convAttention1x1_stage3_1 = nn.Conv2d(16, 16, kernel_size=1, bias=False)
        self.bnAttention1x1_stage3 = nn.BatchNorm2d(16, momentum=BN_MOMENTUM)
        self.convAttention1x1_stage3_2 = nn.Conv2d(16, 16, kernel_size=1, bias=False)


        self.convAttention_stage1_0 = nn.Conv2d(32, 32, kernel_size=1, bias=False)
        self.bnAttentionstage1_0 = nn.BatchNorm2d(32, momentum=BN_MOMENTUM)

        self.convAttention_stage2_0 = nn.Conv2d(32, 32, kernel_size=1, bias=False)
        self.bnAttentionstage2_0 = nn.BatchNorm2d(32, momentum=BN_MOMENTUM)

        self.convAttention_stage2_1 = nn.Conv2d(64, 64, kernel_size=1, bias=False)
        self.bnAttentionstage2_1 = nn.BatchNorm2d(64, momentum=BN_MOMENTUM)


        self.convAttention_stage3_0 = nn.Conv2d(32, 32, kernel_size=1, bias=False)
        self.bnAttentionstage3_0 = nn.BatchNorm2d(32, momentum=BN_MOMENTUM)

        self.convAttention_stage3_1 = nn.Conv2d(64, 64, kernel_size=1, bias=False)
        self.bnAttentionstage3_1 = nn.BatchNorm2d(64, momentum=BN_MOMENTUM)

        self.convAttention_stage3_2 = nn.Conv2d(128, 128, kernel_size=1, bias=False)
        self.bnAttentionstage3_2 = nn.BatchNorm2d(128, momentum=BN_MOMENTUM)


        self.sigmAttention = nn.Sigmoid()


        self.attentionMask_2_1 = self._make_attention_mask(AttentionBottleneck, 32, 32)
        self.attentionMask_3_1 = self._make_attention_mask(AttentionBottleneck, 32, 32)
        self.attentionMask_3_2 = self._make_attention_mask(AttentionBottleneck, 64, 64)

        self.attention_stage_1_1 = self._make_conv1x1_layer(32, 16)

        self.attention_stage_2_1 = self._make_conv1x1_layer(32, 16)
        self.attention_stage_2_2 = self._make_conv1x1_layer(64, 32)

        self.attention_stage_3_1 = self._make_conv1x1_layer(32, 16)
        self.attention_stage_3_2 = self._make_conv1x1_layer(64, 32)
        self.attention_stage_3_3 = self._make_conv1x1_layer(128, 64)


        self.imgMaxPool = nn.MaxPool2d(kernel_size=2, stride=2)

        self.imgAttenConv1 = nn.Conv2d(16, 16, kernel_size=3, padding=1, bias=False)
        self.imgAttenBn1 = nn.BatchNorm2d(16, momentum=BN_MOMENTUM)

        self.imgAttenConv2 = nn.Conv2d(32, 32, kernel_size=3, padding=1, bias=False)
        self.imgAttenBn2 = nn.BatchNorm2d(32, momentum=BN_MOMENTUM)

        self.imgAttenConv3 = nn.Conv2d(64, 64, kernel_size=3, padding=1, bias=False)
        self.imgAttenBn3 = nn.BatchNorm2d(64, momentum=BN_MOMENTUM)

        self.imgAttenConv4 = nn.Conv2d(128, 128, kernel_size=3, padding=1, bias=False)
        self.imgAttenBn4 = nn.BatchNorm2d(128, momentum=BN_MOMENTUM)


        self.imgAtten_up = nn.Upsample(scale_factor=2, mode='bilinear')

        self.imgAtten_deConv3_2 = self._make_deconv_layer(128, 64)  # for branch 3 to 2
        self.imgAtten_conv3_2 = nn.Conv2d(128, 64, kernel_size=1, bias=False)

        self.imgAtten_deConv2_1 = self._make_deconv_layer(64, 32)  # for branch 2 to 1
        self.imgAtten_conv2_1 = nn.Conv2d(64, 32, kernel_size=1, bias=False)

        self.imgAtten_deConv1_0 = self._make_deconv_layer(32, 16)  # for branch 1 to 0
        self.imgAtten_conv1_0 = nn.Conv2d(32, 16, kernel_size=1, bias=False)

        self.imgAtten_conv2 = nn.Conv2d(128, 64, kernel_size=1, bias=False)
        self.imgAtten_bn2 = nn.BatchNorm2d(64, momentum=BN_MOMENTUM)

        self.imgAtten_conv1 = nn.Conv2d(64, 32, kernel_size=1, bias=False)
        self.imgAtten_bn1 = nn.BatchNorm2d(32, momentum=BN_MOMENTUM)

        self.imgAtten_conv0 = nn.Conv2d(32, 16, kernel_size=1, bias=False)
        self.imgAtten_bn0 = nn.BatchNorm2d(16, momentum=BN_MOMENTUM)
        self.RELU = nn.ReLU(inplace=True)
        ...
        self.attentionModule2 = self._make_attention_layer(AttentionBottleneck, 32, 32, 2)
        self.deConv1 = self._make_deconv_layer(32, 32)
        ...
        self.attentionModule3 = self._make_attention_layer(AttentionBottleneck, 64, 64, 2)
        self.deConv2_1 = self._make_deconv_layer(32, 32)
        self.deConv2_2 = self._make_deconv_layer(64, 64)
        ...
        self.imgAttention1 = self._make_img_attention(Img_Attention_Block, 3, 64)   ######### image attention
        self.imgAttention2 = self._make_img_attention(Img_Attention_Block, 3, 128)   ######### image attention
        self.imgAttention3 = self._make_img_attention(Img_Attention_Block, 3, 256)   ######### image attention
        self.imgAttention4 = self._make_img_attention(Img_Attention_Block, 3, 512)   ######### image attention


        self.attentionModule4 = self._make_attention_layer(AttentionBottleneck, 128, 128, 2)
        self.deConv3_1 = self._make_deconv_layer(32, 32)
        self.deConv3_2 = self._make_deconv_layer(64, 64)
        self.deConv3_3 = self._make_deconv_layer(128, 128)
    ...
    def _make_attention_layer(self, block, inplanes, planes, blocks, stride=1):   ##create attention module
        downsample = False
        ...
        # self.inplanes = planes * block.channelExpansion
