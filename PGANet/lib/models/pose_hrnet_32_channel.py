...
cfg_path = os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.attentionModule2 = self._make_attention_layer(AttentionBottleneck, 64, 64, 2)
        self.deConv1 = self._make_deconv_layer(64, 64)
        ...
        self.attentionModule3 = self._make_attention_layer(AttentionBottleneck, 128, 128, 2)
        ...
        self.imgAttention1 = self._make_img_attention(Img_Attention_Block, 3, 128)
        self.imgAttention2 = self._make_img_attention(Img_Attention_Block, 3, 256)
        self.imgAttention3 = self._make_img_attention(Img_Attention_Block, 3, 512)
        self.imgAttention4 = self._make_img_attention(Img_Attention_Block, 3, 1024)


        self.attentionModule4 = self._make_attention_layer(AttentionBottleneck, 256, 256, 2)
        self.deConv3_1 = self._make_deconv_layer(64, 64)
        self.deConv3_2 = self._make_deconv_layer(128, 128)
        self.deConv3_3 = self._make_deconv_layer(256, 256)
